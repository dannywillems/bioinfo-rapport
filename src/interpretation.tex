...
Quant à la seconde cible, nous pouvons remarquer qu'il y a peu de
correspondance. Cependant, si nous zoomons sur certaines zones, nous pouvons
...
soit très peu de droite et très éparpillé (très petits segments de droites lors
du zoom, cible 2).
